...
class Wav2Vec(nn.Module):
    ...
    def __init__(self,
                 ...
                 front_kernel_sizes=(10, 8, 4, 4, 4),
                 front_strides=(5, 4, 2, 2, 2),
                 front_channels=(16, 32, 64, 128, 128), front_bias=True):
        ...
        self.frontend = FrontEnd(
            kernel_sizes=front_kernel_sizes, strides=front_strides, channels=front_channels, bias=front_bias
        )

        self.encoder_embed_dim = input_size
        self.embed  = front_channels[-1]
